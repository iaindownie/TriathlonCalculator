...
public class PaceMilesFrag extends Fragment implements View.OnClickListener {
	 ...
	 */
	public static PaceMilesFrag newInstance(int sectionNumber) {
		PaceMilesFrag fragment = new PaceMilesFrag();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		text1b.setWidth(10);
		text1c.setWidth(10);
		lv = (ListView) rootView.findViewById(R.id.PaceMilesListView01);
	...
	public void onClick(View v) {
		...
		case R.id.ClearButton:
			...
			lv = (ListView) getActivity()
					.findViewById(R.id.PaceMilesListView01);
			lv.setAdapter(null);
			timeButton.setEnabled(true);
			distanceButton.setEnabled(true);
			paceButton.setEnabled(true);
	...
	public void setSplits(double dist, double total) {
		lv = (ListView) getActivity().findViewById(R.id.PaceMilesListView01);
